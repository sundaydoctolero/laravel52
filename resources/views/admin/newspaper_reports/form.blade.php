                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class = "col-md-6">
                            ...
                            {!! Form::select('publication_id',$publication_lists,null,['class'=>'form-control','required'=>'true','readonly'=>'true']) !!}
                        </div>

                        <div class = "col-md-2">
                            {!! Form::label('publication_date', 'Publication Date :') !!}
                            {!! Form::date('publication_date',null,['class'=>'form-control','required'=>'true','readonly'=>'true']) !!}
                        </div>
