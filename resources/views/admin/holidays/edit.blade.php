        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body" style=background-color:ghostwhite>
                    {!! Form::model($holiday,['method'=>'PATCH','url' => '/holidays/'.$holiday->id,'enctype'=>'multipart/form-data']) !!}
                    <div class = "col-md-offset-1">
                        <font size = "16" face = "microsoft sans serif"> <h1 class = "fa fa-edit">&nbsp<tt>Modify Holiday</tt></h1></font>
                    </div>
                    <hr style="height:2px; border:none; color:#000; background-color:#282B2E;">
                    @include('admin.holidays.form',['buttonlabel'=>'Update Holiday'])
                </div>
