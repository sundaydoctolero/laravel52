<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="/tasks"><i class="fa fa-sticky-note"></i> <span>Task &nbsp &nbsp</span><small class="label label-danger">{{ $tasks_open }}</small><small class="label label-success">{{ $tasks_open }}</small></a></li>
